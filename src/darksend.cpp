...
{
    if(fLiteMode) return; // ignore all BitcoinMonster related functionality
...
/*
    ...
    allow endless transaction that would bloat BitcoinMonster and make it unusable. To
...
{
    if(fLiteMode) return; // disable all BitcoinMonster specific functionality
    ...
    RenameThread("bitcoinmonster-privatesend");
